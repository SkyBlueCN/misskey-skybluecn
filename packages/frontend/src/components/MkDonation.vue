...
<div class="_panel _shadow" :class="$style.root">
	...
	<div :class="$style.icon">
		<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-device-desktop" width="40" height="40" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
	...
	<div :class="$style.main">
		<div :class="$style.title">获取“天蓝中文桌面客户端”</div>
		<div :class="$style.text">
			通过“天蓝中文桌面客户端”，您可以获得更完整、更方便的服务。
			...
			<div style="margin-top: 0.2em;">
				<MkLink target="_blank" url="https://go.skybluecn.com/link/desktop">{{ i18n.ts.learnMore }}</MkLink>
			</div>
		</div>
		<div class="_buttons">
